...
import (
	...
	"github.com/pdkovacs/xcaliapp/internal/vcblobstore"
	"github.com/pdkovacs/xcaliapp/internal/vcblobstore/git"
	"github.com/pdkovacs/xcaliapp/internal/vcblobstore/git/gitlab"
...
func TestGitRepositoryTestSuite(t *testing.T) {
	for _, repoController := range BlobstoreProvidersToTest() {
		suite.Run(t, &BlobstoreTestSuite{RepoController: repoController, TestSequenceId: "github.com/pdkovacs/xcaliapp/internal/vcblobstore", Ctx: context.Background()})
	}
}
