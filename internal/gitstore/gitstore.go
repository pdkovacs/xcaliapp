...
import (
	...
	"github.com/pdkovacs/xcaliapp/internal/vcblobstore/git/local"
...
func NewLocalGitStore(pathToStore string, pathToDrawings string, logger *zerolog.Logger) (*LocalGitRepo, error) {
	...
	gitstoreLogger := logger.With().Str("module", "github.com/pdkovacs/xcaliapp/internal/gitstore").Logger()
